...
import { ArrowLeft, Plus, Image, RefreshCw } from 'lucide-react';
import { Button } from '@/components/common/Button';
import { Input } from '@/components/common/Input';
import { Select } from '@/components/common/Select';
import { Textarea } from '@/components/common/Textarea';
import { Card } from '@/components/common/Card';
import { createBook, getModules } from '@/utils/supabase';
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <h2 className="text-2xl font-serif font-bold text-ink">添加图书</h2>
      </div>
      ...
      <Card>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Select label="所属模块" value={module_id} onChange={(e) => setModuleId(e.target.value)}>
            {modules.map((module) => (
